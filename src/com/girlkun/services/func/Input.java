    ...
    public void doInput(Player player, Message msg) {
        try {
            ...
            switch (player.iDMark.getTypeInput()) {
                ...
                case BUFF_ITEM_VIP:
                    if (player.isAdmin()) {
                        Player pBuffItem = Client.gI().getPlayer(Integer.parseInt(text[0]));
                            ...
                            if (goldTrade <= 0 || goldTrade >= 1000001) {
                                ...
                                if (goldTrade >= 50000) {
                                    // qua vip 
                                        ...
                                        Item csv = ItemService.gI().createNewItem((short) 397, 1);
                                        InventoryServiceNew.gI().addItemBag(player, csv);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được 1 Quà Vip");
                                ...
                                if (goldTrade >= 100000) {
                                    ...
                                    Item thehongngoc = null;                    
                                        ...
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được 1 Vé tặng hồng ngọc");                  
                                    InventoryServiceNew.gI().sendItemBags(player);
                                }
                                if (goldTrade >= 10000 && goldTrade < 20000) {
                                    // capsule bac
                                    PlayerDAO.subvnd(player, goldTrade);//* coinGold
                                   
                                    Item ngoc = ItemService.gI().createNewItem((short) 861, goldTrade/2 * Manager.KHUYEN_MAI_NAP);// x3
                                    InventoryServiceNew.gI().addItemBag(player, ngoc);
                                    
                                        Item csb = ItemService.gI().createNewItem((short) 573, 1);
                                        InventoryServiceNew.gI().addItemBag(player, csb);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format(goldTrade/2 * Manager.KHUYEN_MAI_NAP)//* ratioGold * 2
                                                + " " + (ngoc.template.name) + " và 1 Capsule Bạc");
                                    
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade;
                                    GirlkunDB.executeUpdate("update player set vnd = (vnd + " + goldTrade //* coinGold
                                            + ") where id = " + player.id);
                                }else if (goldTrade >= 20000 && goldTrade < 50000) {
                                    // capsule vàng 
                                    PlayerDAO.subvnd(player, goldTrade);//* coinGold
                                    Item ngoc = ItemService.gI().createNewItem((short) 861, goldTrade/2 * Manager.KHUYEN_MAI_NAP);// x3
                                    InventoryServiceNew.gI().addItemBag(player, ngoc);
                                   
                                        Item csv = ItemService.gI().createNewItem((short) 574, 1);
                                        InventoryServiceNew.gI().addItemBag(player, csv);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format(goldTrade/2 * Manager.KHUYEN_MAI_NAP)//* ratioGold * 2
                                                + " " + (ngoc.template.name) + " và 1 Capsule Vàng");
                                    ...
                                    PlayerDAO.subvnd(player, goldTrade);//* coinGold
                                    Item ngoc = ItemService.gI().createNewItem((short) 861, goldTrade/2 * Manager.KHUYEN_MAI_NAP);// x3   * 2
                                    InventoryServiceNew.gI().addItemBag(player, ngoc);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade;
                                    Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format(goldTrade/2 * Manager.KHUYEN_MAI_NAP)//* ratioGold * 2
                        ...
                        if (goldTrade % 1000 == 0) {
                            if (goldTrade <= 0 || goldTrade >= 1000001) {
                                ...
                                if (goldTrade >= 10000 && goldTrade < 20000) {
                                    ...
                                    Item ngoc = ItemService.gI().createNewItem((short) 861, goldTrade/2 );// x3
                                    InventoryServiceNew.gI().addItemBag(player, ngoc);
                                    
                                        Item csb = ItemService.gI().createNewItem((short) 573, 1);
                                        InventoryServiceNew.gI().addItemBag(player, csb);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format(goldTrade/2 )//* ratioGold * 2
                                                + " " + (ngoc.template.name) + " và 1 Capsule Bạc");
                                    ...
                                    // capsule vàng 
                                    PlayerDAO.subvnd(player, goldTrade);//* coinGold
                                    Item ngoc = ItemService.gI().createNewItem((short) 861, goldTrade/2 );// 
                                    InventoryServiceNew.gI().addItemBag(player, ngoc);
                                    ...
                                    PlayerDAO.subvnd(player, goldTrade);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 861, goldTrade/2);// x3   * 2
...
//                    int ratioGold = 2; // tỉ lệ đổi tv
                    ...
                    if (Manager.KHUYEN_MAI_NAP != 1) {
                        if (goldTrade1 % 1000 == 0) {
                            if (goldTrade1 <= 0 || goldTrade1 >= 1000001) {
                                ...
                                if (goldTrade1 >= 10000 && goldTrade1 < 20000) {
                                    // capsule bac
                                    PlayerDAO.subvnd(player, goldTrade1);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 457, Manager.SUKIEN != 1 ? ( Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200)) : Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200));// x3
                                    InventoryServiceNew.gI().addItemBag(player, thoiVang);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade1;
                                    
                                        Item thehn = ItemService.gI().createNewItem((short) 573, 1);
                                        InventoryServiceNew.gI().addItemBag(player, thehn);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + (Manager.SUKIEN != 1 ? Util.format(( Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200))) : Util.format(Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200)))//* ratioGold * 2
                                                + " " + (thoiVang.template.name) + " và 1 Capsule Bạc");
                                    
                                    GirlkunDB.executeUpdate("update player set vnd = (vnd + " + goldTrade1 //* coinGold
                                            + ") where id = " + player.id);
                                }else if (goldTrade1 >= 20000 && goldTrade1 < 50000) {
                                    // capsule vang
                                    PlayerDAO.subvnd(player, goldTrade1);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 457, Manager.SUKIEN != 1 ? ( Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200)) : Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200));// x3
                                    InventoryServiceNew.gI().addItemBag(player, thoiVang);
                                    ...
                                    player.achievement.numPayMoney += goldTrade1;
                                        ...
                                        Item thehn = ItemService.gI().createNewItem((short) 574, 1);
                                        InventoryServiceNew.gI().addItemBag(player, thehn);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + (Manager.SUKIEN != 1 ? Util.format(( Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200))) : Util.format(Manager.KHUYEN_MAI_NAP *(goldTrade1 / 200)))//* ratioGold * 2
                                                + " " + (thoiVang.template.name) + " và 1 Capsule Vàng");
                                    
                                    GirlkunDB.executeUpdate("update player set vnd = (vnd + " + goldTrade1 //* coinGold
                                            + ") where id = " + player.id);
                                } else {
                                    PlayerDAO.subvnd(player, goldTrade1);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 457, (Manager.KHUYEN_MAI_NAP * (goldTrade1 / 200)));// x3   * 2
                                    InventoryServiceNew.gI().addItemBag(player, thoiVang);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade1;
                                    Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format((Manager.KHUYEN_MAI_NAP * (goldTrade1 /200)))//* ratioGold * 2
                                            + " " + thoiVang.template.name);
                                    GirlkunDB.executeUpdate("update player set vnd = (vnd + " + goldTrade1 //* coinGold
                                            + ") where id = " + player.id);
                                }
                        ...
                        if (goldTrade1 % 1000 == 0) {
                            if (goldTrade1 <= 0 || goldTrade1 >= 1000001) {
                                ...
                                if (goldTrade1 >= 10000 && goldTrade1 < 20000) {
                                    // capsule bac
                                    PlayerDAO.subvnd(player, goldTrade1);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 457, Manager.SUKIEN != 1 ? ( (goldTrade1 / 200)) : (goldTrade1 / 200));// x3
                                    InventoryServiceNew.gI().addItemBag(player, thoiVang);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade1;
                                        ...
                                        Item thehn = ItemService.gI().createNewItem((short) 573, 1);
                                        InventoryServiceNew.gI().addItemBag(player, thehn);
                                        Service.getInstance().sendThongBao(player, "Bạn nhận được " + (Manager.SUKIEN != 1 ? Util.format(( (goldTrade1 / 200))) : Util.format((goldTrade1 / 200)))//* ratioGold * 2
                                                + " " + (thoiVang.template.name) + " và 1 Capsule Bạc");
                                    ...
                                    PlayerDAO.subvnd(player, goldTrade1);//* coinGold
                                    Item thoiVang = ItemService.gI().createNewItem((short) 457, ((goldTrade1 / 200)));// x3   * 2
                                    InventoryServiceNew.gI().addItemBag(player, thoiVang);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    player.achievement.numPayMoney += goldTrade1;
                                    Service.getInstance().sendThongBao(player, "Bạn nhận được " + Util.format(((goldTrade1 / 200)))//* ratioGold * 2
                                            + " " + thoiVang.template.name);
                                    GirlkunDB.executeUpdate("update player set vnd = (vnd + " + goldTrade1 //* coinGold
                                            + ") where id = " + player.id);
                                }
    ...
    public void createFormGiftCode(Player pl) {
        createForm(pl, GIFT_CODE, "Giftcode Ngọc rồng VH", new SubInput("Gift-code", ANY));
    }
    ...
    public void createFormBuffItemVip(Player pl) {
        createForm(pl, BUFF_ITEM_VIP, "BUFF VIP", new SubInput("ID người chơi", ANY), new SubInput("Id Item", ANY), new SubInput("Chuỗi option vd : 50-20;30-1", ANY), new SubInput("Số lượng", ANY));
    }
    ...
    public void createFormChooseLevelGas(Player pl) {
        createForm(pl, CHOOSE_LEVEL_GAS, "Chọn cấp độ", new SubInput("Cấp độ (1-150)", NUMERIC));
    }
