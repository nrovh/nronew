...
public class GoiRongXuong {
    ...
    public static final String RONG_XUONG_TUTORIAL
            ...
            + "Điều ước rồng 1 sao: 3k Hồng ngọc ; Buff 20% Chỉ số 30p; 30 Thỏi vàng ; Đổi skill 4 Đệ\n"
    ...
    public static final String[] HALLOWEN_1_STAR_WISHES_1
            = new String[]{"Giàu có\n3k Hồng ngọc", "Tăng 20% HP,KI,SD\ntrong 30 Phút", "30 Thỏi vàng",
                "Thay\nChiêu 4\nĐệ tử"};
    //--------------------------------------------------------------------------
            ...
            case ConstNpc.HALLOWEN_1_1:
                switch (this.select) {
                    case 0: //20k hong ngoc
                        this.playerRongXuong.inventory.ruby += 3000;
