...
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_CBS;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_BTET;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_BCHUNG;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_CUA;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_TOM;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_BT;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_SUP;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_HBG;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_GATO;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_TMO;
import static com.girlkun.models.item.ItemTimeSieuCap.TIME_TMODB;
...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTimesieucap.isKeo) {
            sendItemTime(player, 8243, (int) ((TIME_KEO - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeCua)) / 1000));
        }
         if (player.itemTimesieucap.iscbs) {
            sendItemTime(player, 5829, (int) ((TIME_CBS - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeiscbs)) / 1000));
        }
        if (player.itemTimesieucap.isCua) {
            sendItemTime(player, 8060, (int) ((TIME_CUA - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeKeo)) / 1000));
        }
        if (player.itemTimesieucap.isTom) {
            sendItemTime(player, 8062, (int) ((TIME_TOM - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeTom)) / 1000));
        }
        if (player.itemTimesieucap.isBachTuot) {
            sendItemTime(player, 8061, (int) ((TIME_BT - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBachTuot)) / 1000));
        }
        if (player.itemTimesieucap.isSup) {
            sendItemTime(player, 8244, (int) ((TIME_SUP - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeSup)) / 1000));
        }
        if (player.itemTimesieucap.isGato) {
            sendItemTime(player, 8246, (int) ((TIME_GATO - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeGato)) / 1000));
        }
        if (player.itemTimesieucap.isHamburger) {
            sendItemTime(player, 8247, (int) ((TIME_HBG - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeHamburger)) / 1000));
        }
        if (player.itemTimesieucap.isThuocMo) {
            sendItemTime(player, 9068, (int) ((TIME_TMO - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeThuocMo)) / 1000));
        }
        if (player.itemTimesieucap.isThuocMoDB) {
            sendItemTime(player, 9068, (int) ((TIME_TMODB - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeThuocMoDB)) / 1000));
        }
        if (player.itemTimesieucap.isBanhTet) {
            sendItemTime(player, 7079, (int) ((TIME_BTET - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBanhTet)) / 1000));
        }
        if (player.itemTimesieucap.isBanhChung) {
            sendItemTime(player, 7080, (int) ((TIME_BCHUNG - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBanhChung)) / 1000));
        }
