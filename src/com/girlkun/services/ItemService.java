...
public class ItemService {
    ...
    public Item caitrang2011(boolean rating) {
        ...
        item.itemOptions.add(new Item.ItemOption(117, Util.nextInt(3, 10)));//Đẹp + 18% sd
    ...
    public Item vanBay2011(boolean rating) {
        ...
        item.itemOptions.add(new Item.ItemOption(77, new Random().nextInt(2) + 5));
        item.itemOptions.add(new Item.ItemOption(103, new Random().nextInt(2) + 5));
        item.itemOptions.add(new Item.ItemOption(147, new Random().nextInt(2) + 5));
