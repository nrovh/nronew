...
import com.girlkun.models.boss.list_boss.BossThanhGomDietQuy;
...
import com.girlkun.models.boss.list_boss.fide.FideBlack;
...
import com.girlkun.models.boss.list_boss.ThoTrang1;
import com.girlkun.models.boss.list_boss.ThoTrang2;
...
public class BossManager implements Runnable {
    ...
    public void loadBoss() {
        ...
        try {
            ...
            this.createBoss(BossID.FIDEBLACK);
            this.createBoss(BossID.BLACK);
...
//            this.createBoss(BossID.MABU);
            ...
            this.createBoss(BossID.BOSS_TET);
            this.createBoss(BossID.BOSS_TSQ);
//            this.createBoss(BossID.BOSS_THOTRANG);
//            this.createBoss(BossID.BOSS_THOTRANG1);
...
//                    return new BossChienThan();
                ...
                case BossID.BOSS_THOTRANG:
                    return new ThoTrang();
                case BossID.BOSS_THOTRANG1:
                    return new ThoTrang1();
                case BossID.BOSS_THOTRANG2:
                    return new ThoTrang2();
                case BossID.PIC:
                    return new Pic();
                case BossID.POC:
                    return new Poc();
                ...
                case BossID.VUA_COLD:
                    return new Kingcold();
                case BossID.FIDEBLACK:
                    return new FideBlack();
...
//                    return new ZamasKaio();
                ...
                case BossID.BROLYB:
                    return new BrolyB();
                case BossID.BOSS_TSQ:
                    return new BossThanhGomDietQuy();
                default:
                    return null;
            }
        } catch (Exception e) {
