...
public class NhanBan extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        ItemMap i1t = new ItemMap(this.zone, 638, 1, this.location.x + 100, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
        Service.getInstance().dropItemMap(this.zone, i1t);
        
        if (Util.isTrue(4, 10)) {
            ItemMap it = new ItemMap(this.zone, Util.nextInt(1099, 1102), 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x+30, this.location.y - 24), plKill.id);
            Service.getInstance().dropItemMap(this.zone, it);
        }
        // troll
//        if (Util.isTrue(8, 10)) {
//            ItemMap it = new ItemMap(this.zone, 673, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
//            Service.getInstance().dropItemMap(this.zone, it);
//        }
    }
