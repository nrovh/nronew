...
public class Black extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(1, 10)) {
                ...
                ItemMap it3 = new ItemMap(this.zone, 992, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
        ...
        // 
        ItemMap itnew = new ItemMap(this.zone, 707, 1, this.location.x-50, this.location.y, -1);
