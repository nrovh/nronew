...
public class ZamasKaio extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        // rùa con 
        if (Util.isTrue(2, 5)) {         
                ItemMap it3 = new ItemMap(this.zone, 874, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
        ...
        if ((Util.isTrue(2,10))) { // ti le rot do tl la 2/10
                ...
                ItemMap it1 = new ItemMap(this.zone, Manager.itemIds_CUI[randomDo1], 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
