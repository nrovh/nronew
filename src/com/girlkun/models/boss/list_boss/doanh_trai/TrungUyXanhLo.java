...
public class TrungUyXanhLo extends Boss {
    ...
    public void reward(Player plKill) {
        ItemMap itnew = new ItemMap(this.zone, 706, 1, this.location.x+30, this.location.y, -1);
        Service.getInstance().dropItemMap(this.zone, itnew);
        // bdkb
        ItemMap bdkb = new ItemMap(this.zone, 611, 1, this.location.x-30, this.location.y, -1);
        Service.getInstance().dropItemMap(this.zone, bdkb);
