...
public class SongokuTaAc extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        // cải trang 
            ...
            ItemMap ct = Util.ratiItem(this.zone,1112, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 27), plKill.id);
            // option cho cải trang 
            // sd
            ct.options.add(new Item.ItemOption(50, Util.nextInt(20, 40)));
            //hp
            ct.options.add(new Item.ItemOption(77, Util.nextInt(20, 50)));
            //ki
            ct.options.add(new Item.ItemOption(103, Util.nextInt(20, 50)));
            // sdcm
            ct.options.add(new Item.ItemOption(5, Util.nextInt(5, 20)));
            // hsd
