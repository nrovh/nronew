...
public class Cumber extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if(Util.isTrue(9, 10)){
        ItemMap it = new ItemMap(this.zone, 2048, 1, this.location.x+30 , this.zone.map.yPhysicInTop(this.location.x,this.location.y - 24), plKill.id);
        Service.getInstance().dropItemMap(this.zone, it);
         ...
         // cải trang 
            ...
            ItemMap ct = Util.ratiItem(this.zone,1111, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 27), plKill.id);
            // option cho cải trang 
            // sd
            ct.options.add(new Item.ItemOption(50, Util.nextInt(20, 30)));
            //hp
            ct.options.add(new Item.ItemOption(77, Util.nextInt(20, 35)));
            //ki
            ct.options.add(new Item.ItemOption(103, Util.nextInt(20, 35)));
            // sdcm
            ct.options.add(new Item.ItemOption(5, Util.nextInt(3, 12)));
            // hsd
