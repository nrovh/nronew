...
public class BossesData {
    ...
    public static final BossData DR_KORE = new BossData(
            ...
            20000, //dame
            new double[]{450000000L}, //hp
            new int[]{94, 93}, //map join
            new int[][]{
...
//**************************************************************************
    ...
    public static final BossData XEN_BO_HUNG_1 = new BossData(
            ...
            30000,
            new double[]{700000000L},
            new int[]{100},
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.LIEN_HOAN, 7, 10000},
                {Skill.DICH_CHUYEN_TUC_THOI, 1, 50000}},//skill
    ...
    public static final BossData SIEU_BO_HUNG_1 = new BossData(
            "Siêu Xên Hoàn Thiện 1",
            ConstPlayer.XAYDA,
            new short[]{234, 235, 236, -1, -1, -1},
            35000,
            new double[]{900000000L},
            new int[]{103},
            new int[][]{
...
//                {Skill.TAI_TAO_NANG_LUONG, 7, 90000},
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.THAI_DUONG_HA_SAN, 1, 150000}},
            //skill
...
//                {Skill.THAI_DUONG_HA_SAN, 7, 65000},
    ...
    public static final BossData SIEU_BO_HUNG_3 = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 2, 130000},
//                {Skill.TAI_TAO_NANG_LUONG, 7, 90000},
...
//                    {Skill.BIEN_KHI, 5, 100000}
    ...
    public static final BossData VUA_COLD = new BossData(
            ...
            new double[]{1000000000L},
            new int[]{27, 28, 29,30},
            (int[][]) Util.addArray(FULL_KAMEJOKO, FULL_LIENHOAN,FULL_MASENKO), //skill
...
//                {Skill.THAI_DUONG_HA_SAN, 7, 100000},
    ...
    public static final BossData Rong_3Sao = new BossData(
            ...
            new int[]{87}, //map join
            new int[][]{
                {Skill.THOI_MIEN, 1, 125000},
                {Skill.THAI_DUONG_HA_SAN, 2, 50000},
                {Skill.DICH_CHUYEN_TUC_THOI, 1, 10000}}, //skill
            new String[]{"|-1|Gaaaaaa !!!!!!!!",
                "|-2|Tên kia là ai vậy",
                "|-1|Sức mạnh tà ác !"
            }, //text chat 1
...
//                {Skill.TU_SAT, 7, 100000},
                {Skill.KHIEN_NANG_LUONG, 1, 90000},
                {Skill.DE_TRUNG, 7, 10000},
                {Skill.SOCOLA, 1, 10000},
                {Skill.DEMON, 7, 1000}},
    ...
    public static final BossData BROLSP = new BossData(
           "Siêu Super Broly", //name
              ...
              {Skill.ANTOMIC, 1, 13},  {Skill.ANTOMIC, 2, 14},  {Skill.ANTOMIC, 3, 15},{Skill.ANTOMIC, 4, 16},  {Skill.ANTOMIC, 5, 17},{Skill.ANTOMIC, 6, 19},  {Skill.ANTOMIC, 7, 20},
                {Skill.MASENKO, 1, 21}, {Skill.MASENKO, 5, 22}, {Skill.MASENKO, 6, 23},
                    {Skill.KAMEJOKO, 7, 1000},{Skill.TAI_TAO_NANG_LUONG, 2, 40000}},
    ...
    public static final BossData BOSS_DETU_BERUS = new BossData(
            ...
            100000, //dame
            new double[]{20000000000L}, //hp
            new int[]{104}, //map join
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.DICH_CHUYEN_TUC_THOI, 2, 9000},
                {Skill.TAI_TAO_NANG_LUONG, 1, 110000},
                {Skill.THAI_DUONG_HA_SAN, 1, 10000},
                {Skill.LIEN_HOAN, 5, 400},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
    ...
    public static final BossData BOSS_THOTRANG1 = new BossData(
            "Thỏ Trắng", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{885, 886, 887, 127, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000, //dame
    ...
    public static final BossData BOSS_THOTRANG2 = new BossData(
            "Thỏ Trắng", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{885, 886, 887, 127, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000, //dame
...
//    );
    public static final BossData BOSS_DETU_BL = new BossData(
            ...
            new int[]{105}, //map join
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 30000},
                {Skill.TAI_TAO_NANG_LUONG, 2, 110000},
//                {Skill.THAI_DUONG_HA_SAN, 7, 5000},
                {Skill.LIEN_HOAN, 7, 400},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Các ngươi thật là yếu ớt",
                "|-1|Muốn có Đệ Berus đâu có dễ",
                "|-1|Không có ai đủ mạnh để đấu với ta sao?",
    ...
    public static final BossData BOSS_TSQ = new BossData(
            "Tanjiro", //name
            ...
            new int[][]{
                ...
                {Skill.LIEN_HOAN, 7, 300},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Cá tháng tư !",
                "|-1|chào con gà !",
                "|-1|Không có ai đủ mạnh để đấu với ta sao?",
                "|-1|ngu thì chết !",}, //text chat 2
            new String[]{"|-1|Đen lắm em trai !"}, //text chat 3
            REST_10_M
    );
    public static final BossData BOSS_TET = new BossData(
            ...
            new int[][]{
                ...
                {Skill.LIEN_HOAN, 7, 300},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|ta sẽ hủy diệt trái đất này !",
                "|-1|Gừ Gừ !",
                "|-1|Không có ai đủ mạnh để đấu với ta sao?",
                "|-1|Hakaii !",}, //text chat 2
            new String[]{"|-1|Đen lắm em trai !"}, //text chat 3
            REST_15_M
    );
...
//                    {Skill.THAI_DUONG_HA_SAN, 1, 15000}
    ...
    public static final BossData AN_TROM = new BossData(
            ...
            new int[]{5},
            new int[][]{
                {Skill.THAI_DUONG_HA_SAN, 2, 15000}},
