...
public class NpcFactory {
    ...
    private static final int COST_HD = 500000000;
...
//                                 this.npcChat(player, "Chức năng đang bảo trì ");
                                ...
                                GasService.gI().openKhiGas(player, (int) Integer.parseInt(String.valueOf(PLAYERID_OBJECT.get(player.id))));
                                break;
                        }
                    }
                }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7| SỰ KIỆN TRUNG THU"
                            ...
                            + "\n|-1|- Bánh Hạt sen : 49 Hạt sen + 50 Bột nếp + 1 Mồi lửa"
                            + "\n|-1|- Bánh Đậu xanh : 49 Đậu xanh + 50 Bột nếp + 1 Mồi lửa"
                            + "\n|-1|- Bánh Thập cẩm : 49 Hạt sen + 49 Đậu xanh + 49 Bột nếp + 2 Mồi lửa"
                            + "\n|7|Làm bánh sẽ tốn phí 100Tr Vàng/lần "
                            + "\n\n|1|Điểm sự kiện : " + Util.format(player.NguHanhSonPoint) + " Điểm",
                            "Thể lệ", "Làm bánh", "Đổi điểm\nTrung thu", "Shop Trung thu");
                }
            }
                        ...
                        switch (select) {
                            ...
                            case 2: {
                                this.createOtherMenu(player, 2222,
                                        ...
                                        + "|2|Mốc 250 Điểm\n"
                                        + "|4|200 Mảnh thiên sứ ngẫu nhiên, 5 rương thần linh, 1k hồng ngọc , 3 Hộp quà Trung thu, 10 Thẻ gia hạn, 1 Phiếu giảm giá + 10 Quà Trung Thu \n"
                                        + "|2|Mốc 175 Điểm\n"
                                        + "|4|100 Mảnh thiên sứ ngẫu nhiên, 4 rương thần linh, 750 hồng ngọc , 8 Thẻ gia hạn, 2 Hộp Trung thu  + 10 Quà Trung Thu \n"
                                        + "|2|Mốc 100 Điểm\n"
                                        + "|4|50 Mảnh thiên sứ ngẫu nhiên, 2 rương thần linh, 400 hồng ngọc , 5 Thẻ gia hạn, 1 Hộp Trung thu  + 10 Quà Trung Thu \n"
                                        + "|2|Mốc 50 Điểm\n"
                                        + "|4|10 Mảnh thiên sứ ngẫu nhiên, 1 rương thần linh, 200 hồng ngọc , + 5 Quà Trung Thu\n"
                                        + "|2|Mốc 10 Điểm\n"
                                        + "|4|10 Mảnh thiên sứ ngẫu nhiên, 2 Quà Trung Thu "
                                        + "\n|7|Điểm sự kiện : " + Util.format(player.NguHanhSonPoint) + " Điểm"
                                        + "\n|1|Điểm Top Trung thu : " + Util.format(player.inventory.coupon) + " Điểm",
                                        "250 Điểm", "175 Điểm", "100 Điểm", "50 Điểm", "10 Điểm");
                                break;
                            }
                            case 3: {
                                ShopServiceNew.gI().opendShop(player, "SHOP_TRUNGTHU", true);
                                break;
                            }
                        }
...
//                                        throw new RuntimeException(e);
                                ...
                                if (hatsen == null || hatsen.quantity < 49) {
                                    this.npcChat(player, "|7|Bạn không đủ 49 Hạt sen");
                                } else if (botnep == null || botnep.quantity < 50) {
                                    this.npcChat(player, "|7|Bạn không đủ 50 Bột nếp");
                                } else if (moilua == null || moilua.quantity < 1) {
                                    this.npcChat(player, "|7|Bạn không đủ 1 Mồi lửa");
                                } else if (player.inventory.gold < 100_000) {
                                    this.npcChat(player, "|7|Bạn không đủ 100Tr Vàng");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    this.npcChat(player, "|7|Hành trang của bạn không đủ chỗ trống");
                                } else {
                                    player.inventory.gold -= 100_000;
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, hatsen, 49);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, botnep, 50);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, moilua, 1);
                                    Service.getInstance().sendMoney(player);
...
//                                        throw new RuntimeException(e);
                                ...
                                if (dauxanh == null || dauxanh.quantity < 49) {
                                    this.npcChat(player, "|7|Bạn không đủ 49 Đậu xanh");
                                } else if (botnep == null || botnep.quantity < 50) {
                                    this.npcChat(player, "|7|Bạn không đủ 50 Bột nếp");
                                } else if (moilua == null || moilua.quantity < 1) {
                                    this.npcChat(player, "|7|Bạn không đủ 1 Mồi lửa");
                                    ...
                                    player.inventory.gold -= 100_000;
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, dauxanh, 49);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, botnep, 50);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, moilua, 1);
                                    Service.getInstance().sendMoney(player);
...
//                                        throw new RuntimeException(e);
                                ...
                                if (hatsen == null || hatsen.quantity < 49) {
                                    this.npcChat(player, "|7|Bạn không đủ 49 Hạt sen");
                                } else if (botnep == null || botnep.quantity < 49) {
                                    this.npcChat(player, "|7|Bạn không đủ 49 Bột nếp");
                                } else if (dauxanh == null || dauxanh.quantity < 49) {
                                    this.npcChat(player, "|7|Bạn không đủ 49 Đậu xanh");
                                } else if (moilua == null || moilua.quantity < 2) {
                                    this.npcChat(player, "|7|Bạn không đủ 2 Mồi lửa");
                                } else if (player.inventory.gold < 200_000) {
                                    this.npcChat(player, "|7|Bạn không đủ 200Tr Vàng");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    this.npcChat(player, "|7|Hành trang của bạn không đủ chỗ trống");
                                } else {
                                    player.inventory.gold -= 200_000;
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, hatsen, 49);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, dauxanh, 49);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, botnep, 49);
                        ...
                        switch (select) {
                            case 0: {
                                ...
                                if (player.NguHanhSonPoint < 250) {
                                    this.npcChat(player, "|7|Bạn không đủ 250 Điểm sự kiện");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) < 6) {
                                    this.npcChat(player, "|7|Hành trang của bạn cần ít nhất 6 ô trống");
                                } else {
                                    player.NguHanhSonPoint -= 250;
                                    player.inventory.coupon += 250;
                                    ...
                                    Item qtt = ItemService.gI().createNewItem((short) 736);
                                    ...
                                    hoptt.quantity = 3;
                                    thegh.quantity = 10;
                                    InventoryServiceNew.gI().addItemBag(player, qtt);
                                    ...
                                    this.npcChat(player, "|4|Bạn nhận được 200 " + manhthiensu.template.name
                                            + ", 5 Rương thần linh, 3 Hộp Trung thu, 10 Thẻ gia hạn, 1 Phiếu giảm giá và 1k Hồng ngọc, 10 Quà trung thu !");
                                }
                                break;
                            }
                            case 1: {
                                byte randommanh = (byte) new Random().nextInt(Manager.itemManh.length);
                                int manh = Manager.itemManh[randommanh];
                                if (player.NguHanhSonPoint < 175) {
                                    this.npcChat(player, "|7|Bạn không đủ 175 Điểm sự kiện");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) < 5) {
                                    this.npcChat(player, "|7|Hành trang của bạn cần ít nhất 5 ô trống");
                                } else {
                                    player.NguHanhSonPoint -= 175;
                                    player.inventory.coupon += 175;
                                    player.inventory.ruby += 750;
                                    Service.getInstance().sendMoney(player);
                                    Item manhthiensu = ItemService.gI().createNewItem((short) manh);
                                    Item ruongthan = ItemService.gI().createNewItem((short) 1334);
                                    Item hoptt = ItemService.gI().createNewItem((short) 1342);
                                    ...
                                    this.npcChat(player, "|4|Bạn nhận được 100 " + manhthiensu.template.name
                                            + ", 4 Rương thần linh, 2 Hộp Trung thu, 8 Thẻ gia hạn và 750 Hồng ngọc, 10 Quà trung thu !");
                                }
                                break;
                            }
                            case 2: {
                                byte randommanh = (byte) new Random().nextInt(Manager.itemManh.length);
                                int manh = Manager.itemManh[randommanh];
                                if (player.NguHanhSonPoint < 100) {
                                    this.npcChat(player, "|7|Bạn không đủ 100 Điểm sự kiện");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) < 5) {
                                    this.npcChat(player, "|7|Hành trang của bạn cần ít nhất 5 ô trống");
                                } else {
                                    player.NguHanhSonPoint -= 100;
                                    player.inventory.coupon += 100;
                                    player.inventory.ruby += 400;
                                    Service.getInstance().sendMoney(player);
                                    Item manhthiensu = ItemService.gI().createNewItem((short) manh);
                                    Item ruongthan = ItemService.gI().createNewItem((short) 1334);
                                    Item hoptt = ItemService.gI().createNewItem((short) 1342);
                                    ...
                                    this.npcChat(player, "|4|Bạn nhận được 50 " + manhthiensu.template.name
                                            + ", 3 Rương thần linh, 1 Hộp Trung thu, 5 Thẻ gia hạn và 400 Hồng ngọc, 10 Quà trung thu !");
                                }
                                break;
                            }
                            case 3: {
                                ...
                                if (player.NguHanhSonPoint < 50) {
                                ...
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) < 3) {
                                    this.npcChat(player, "|7|Hành trang của bạn cần ít nhất 3 ô trống");
                                } else {
                                    ...
                                    ruongthan.quantity = 1;
                                    InventoryServiceNew.gI().addItemBag(player, manhthiensu);
                                    InventoryServiceNew.gI().addItemBag(player, ruongthan);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 10 " + manhthiensu.template.name
                                            + ", 1 Rương thần linh và 200 Hồng ngọc, 5 Quà trung thu");
                                }
                                break;
                            }
                            case 4: {
                                byte randommanh = (byte) new Random().nextInt(Manager.itemManh.length);
                                int manh = Manager.itemManh[randommanh];
                                if (player.NguHanhSonPoint < 10) {
                                    this.npcChat(player, "|7|Bạn không đủ 10 Điểm sự kiện");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) < 3) {
                                    this.npcChat(player, "|7|Hành trang của bạn cần ít nhất 3 ô trống");
                                } else {
                                    player.NguHanhSonPoint -= 10;
                                    player.inventory.coupon += 10;
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 104) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|7| NHẬN Linh Thú "
                                + "\n\n|2|Đổi Quả Trứng hắc ám Mở ra linh thú cần:"
                                + "\n|5|X99 Linh thạch + 10 Thỏi vàng"
                                + "\b\b|3|Khi sử dụng Quả Trứng hắc ám sẽ nhận được linh thú Ngẫu nhiên với các dòng chỉ số random như sau"
                                + "\n|4|SD : 10-35%"
                                + "\nHP,KI : 15-40%"
                                + "\nHút HP,KI : 5-15%"
                                + "\n\n|7| Ngươi có chắc muốn đổi Quả Trứng hắc ám ??",
                                "Quả Trứng\n hắc ám", "Từ chối");
                    }
                }
            }
                            ...
                            switch (select) {
                                case 0: {
                                    ...
                                    try {
                                        ...
                                        honLinhThu = InventoryServiceNew.gI().findItemBag(player, 1263);
                                        honLinhThu1 = InventoryServiceNew.gI().findItemBag(player, 1264);
                                        thoivang = InventoryServiceNew.gI().findItemBag(player, 457);
                                    } catch (Exception e) {
//                                        throw new RuntimeException(e);
                                    }
                                    if (honLinhThu == null || honLinhThu.quantity < 99 || honLinhThu1 == null || honLinhThu1.quantity < 99) {
                                    ...
                                    Service.getInstance().sendMoney(player);
                                    Item trungLinhThu = ItemService.gI().createNewItem((short) 2027);
                                    //trungLinhThu.itemOptions.add(new Item.ItemOption(30, 1));
                                    InventoryServiceNew.gI().addItemBag(player, trungLinhThu);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|1|Bạn nhận được 1 trứng linh thú");
                                    break;
                                }
                            }
                        }
...
//                                        if (MartialCongressService.gI().check == false){
                                    if (InventoryServiceNew.gI().finditemWoodChest(player)) {
                                        if (player.inventory.ruby >= 20) {
                                            MartialCongressService.gI().startChallenge(player);
//                                            Service.getInstance().sendThongBao(player, "Chức năng đang bảo trì");
                                        } else {
                                            Service.getInstance().sendThongBao(player, "Không đủ hồng ngọc, còn thiếu " + Util.numberToMoney(20 - player.inventory.ruby) + " Hồng ngọc");
                                        }
                                    } else {
...
//                                            Service.getInstance().sendThongBao(player, "Chức năng đang bảo trì");
                                            MartialCongressService.gI().startChallenge(player);
                                            player.goldChallenge += 20;
                                        } else {
                                            Service.getInstance().sendThongBao(player, "Không đủ vàng, còn thiếu " + Util.numberToMoney(20 - player.inventory.ruby) + " vàng");
                                        }
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Hãy mở rương báu vật trước");
                                    }
                            ...
                            case 0:
                                if (Manager.KHUYEN_MAI_NAP != 1) {
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_HN,
                                            ...
                                            + "\n\n|5|Nhập 10.000Đ được 5.000 Hồng ngọc"
                                            + "\n\n|3| Server đang x" + Manager.KHUYEN_MAI_NAP + " Quy đổi "
                                            + "(10.000Đ = " + Util.format(Manager.KHUYEN_MAI_NAP * 5000) + " Hồng ngọc)"
                                            + "\n\n|3|(>= 100.000đ Được tặng Vé chuyển Hồng ngọc)"
                                            + "\n|3|(>= 10.000 Được tặng Capsule Bạc)"
                                            + "\n|3|(>= 20.000 Được tặng Capsule Vàng)"
                                            + "\n|3|(>= 50.000 Được tặng Hộp Vip)",
                                            "Đồng ý", "Từ chối");
                                } else if (Manager.SUKIEN == 1) {
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_HN,
                                            "|7|QUY ĐỔI HỒNG NGỌC\n|6|Quy đổi Hồng ngọc, giới hạn đổi không quá 1.000.000đ\n\n|1|Tiền hiện còn : " + " " + Util.format(player.getSession().vnd)
                                            + "\n\n|5|Nhập 10.000Đ được 5.000 Hồng ngọc và được 10 Điểm Sự kiện"
                                            + "\n\n|3|(>= 100.000đ Được tặng Vé chuyển Hồng ngọc)"
                                            + "\n|3|(>= 10.000 Được tặng Capsule Bạc)"
                                            + "\n|3|(>= 20.000 Được tặng Capsule Vàng)"
                                            + "\n|3|(>= 50.000 Được tặng Hộp Vip)",
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    String checkvnd;
                    int thoivang;
                    if (player.vnd >= 0 && player.vnd < 10000) {
                        checkvnd = "Tân Thủ";
                        thoivang = 2;
                    } else if (player.vnd >= 10000 && player.vnd < 50000) {
                        checkvnd = "Dân Thường";
                        thoivang = 4;
                    } else if (player.vnd >= 50000 && player.vnd < 100000) {
                        checkvnd = "VIP";
                        thoivang = 8;
                    } else if (player.vnd >= 100000 && player.vnd < 500000) {
                        checkvnd = "SVIP";
                        thoivang = 10;
                    } else {
                        checkvnd = "SSVIP";
                    ...
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                ...
                                + "\n|2| Quy đổi tiền <10.000đ = Tân Thủ (Nhận 2 Thỏi vàng/Ngày)"
                                + "\n Quy đổi tiền >10.000đ và <50.000đ = Dân Thường (Nhận 4 Thỏi vàng/Ngày)"
                                + "\n Quy đổi tiền >50.000đ và <100.000đ = VIP (Nhận 8 Thỏi vàng/Ngày)"
                                + "\n Quy đổi tiền >100.000đ và <500.000đ = SVIP (Nhận 10 Thỏi vàng/Ngày)"
                                + "\n Quy đổi tiền >500.000đ = SSVIP (Nhận 20 Thỏi vàng/Ngày)"
                                ...
                                "Đổi Mật Khẩu", "Nhận 10k Ngọc xanh", "Nhận đệ tử", "Nhận\nVàng", "Giftcode", "Điểm danh\nngày", "Đến\n Khu Test Dame");
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 1:
                                ...
                                Service.getInstance().sendMoney(player);
                                Service.getInstance().sendThongBao(player, "|1|Bạn vừa nhận được 10000000 Ngọc xanh");
                                break;
                            case 2:
                                if (player.pet == null) {
                            ...
                            case 3:
                                ...
                                if (player.getSession().goldBar > 0) {
                                    ...
                                    this.npcChat(player, "Con đang không có thỏi vàng hãy nạp tiền vào để có :> !!!");
                                }
                                break;
                            ...
                            case 5:
                                if (player.diemdanh == 0) {
                                    ...
                                    Item wind = ItemService.gI().createNewItem((short) 1334, 1);
                                    wind.itemOptions.add(new Item.ItemOption(30, 1));
                                    InventoryServiceNew.gI().addItemBag(player, wind);
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (boss != null && !boss.isDie()) {
                                        if (boss == null) {
                                            Service.getInstance().sendThongBao(player, "boss biến mất vui lòng quay lại sao 5 phút");
                                            return;
                                        }
...
//                                case 3: //tiệm hớt tóc
//                                    if (player.vnd >= 20000) {
//                                        ShopServiceNew.gI().opendShop(player, "SHOP_Hot", true);
//                                    } else {
//                                        Service.getInstance().sendThongBao(player, "Bạn nạp chưa đủ 20k ! Vui lòng nạp thêm");
//                                    }
//                                    break;
//                                case 4: //tiệm hớt tóc
//                                    if (player.vnd >= 50000) {
//                                        ShopServiceNew.gI().opendShop(player, "SHOPNEW", true);
//                                    } else {
//                                        Service.getInstance().sendThongBao(player, "shop này chỉ cho người có VIP ! Vui lòng nạp thêm");
//                                    }
//
//                                    break;
//                                case 5: //tiệm hớt tóc
//                                    if (player.vnd >= 5000000) {
//                                        ShopServiceNew.gI().opendShop(player, "PET", true);
//                                    } else {
//                                        Service.getInstance().sendThongBao(player, "shop này Tạm dừng hoạt động !");
//                                    }
//
//                                    break;
                                //case 4: //tiệm mới thêm 
                                //  ShopServiceNew.gI().opendShop(player, "SHOPNEW", false);
                                //break;
                            }
                        }
                    }
                            ...
                            switch (select) {
                                ...
                                case 5: //nâng cấp Chân mệnh
                                    this.createOtherMenu(player, 5701,
                                            ...
                                            + "\n\n|5|Bạn Được Tặng Free Chân Mệnh cấp 1 Bú Nhanh"
    ...
    public static Npc duongtank(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (mapId == 0 || mapId == 5) {
                        this.createOtherMenu(player, 0, "Ngũ Hàng Sơn x2 Tnsm\nHỗ trợ cho Ae Từ\b|1|100 Tỷ SM đến 150 Tỷ SM?", "OK", "Oéo");
                    }
                    if (mapId == 123) {
                    ...
                    switch (select) {
                        case 0:
                            if (mapId == 48 || mapId == 5 || mapId == 0) {
                                if (player.nPoint.power < 100000000000L || player.nPoint.power >= 150000000000L) {
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 1, "|2|Gặp Npc Mị Nương: Chọn Hộ Tống Rồi Dắt BUNMA đến Vị Trí được chỉ định\n"
                                            + "Phần quà Random 1-5 Thỏi vàng và Random 5-10 Xu hộ tống. Phí hộ tống là 1ti vang \n|7|Mỗi ngày chỉ được Hộ tống tối đa 5 lần", "Hiểu rồi");
                                    break;
                                case 1:
                                    //this.createOtherMenu(player, 1, "chức năng tạm thời đống", "Hiểu rồi");
                                    // tạm đống cn này 
                                    if (TaskService.gI().getIdTask(player) >= ConstTask.TASK_20_0) {
                                        this.createOtherMenu(player, 12345,
                                                "|7|Bạn có chắc muốn dùng 1ti vang để Hộ tống Bunma đến điểm đích để nhận được phần quà hấp dẫn không?", "Đồng ý", "Từ chối");
                                    } else {
                                ...
                                case 0:
                                    if (TaskService.gI().getIdTask(player) >= ConstTask.TASK_20_0) {
                                        ...
                                        if (oldDuongTank != null) {
                                            ...
                                            this.npcChat(player, "|7|Nhà ngươi không đủ 1 ti vang");
                                        } else if (player.taixiu.hotong >= 3) {
                                            this.npcChat(player, "|7|Mỗi ngày chỉ được Hộ tống tối đa 3 lần");
                                        } else {
                                            BossData bossDataClone = new BossData(
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 45) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Con muốn làm gì nào", "Đến Kaio", "Vòng Quay mai mắn");
                    }
//                    if (this.mapId == 0) {
//                        this.createOtherMenu(player, 0,
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    break;
//                                case 2: 
//                                    ChangeMapService.gI().changeMapBySpaceShip(player, 106, -1, 354);
//                                    break;
                            }
                ...
                if (canOpenNpc(player)) {
                    ...
                    if (nPlSameClan < DoanhTrai.N_PLAYER_MAP) {
                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                ...
                                + "tuy nhiên ta khuyên ngươi nên đi cùng với 2-3 người để khỏi chết.\n"
                                + "Hahaha.", "OK", "Hướng\ndẫn\nthêm");
                        return;
                    }
                    ...
                    createOtherMenu(player, ConstNpc.MENU_JOIN_DOANH_TRAI,
                            ...
                            + "không?\nĐể vào, ta khuyên ngươi nên có 2-3 người cùng bang đi cùng",
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                            ...
                            case 0:
                                if (player.inventory.ruby >= 10000) {
                                    ...
                                    Service.getInstance().sendThongBao(player,
                                            ...
                                            + Util.numberToMoney((10000 - player.inventory.ruby)) + " hồng ngọc");
                                }
                                break;
                        }
                        ...
                        switch (select) {
                            case 0:
                                if (player.inventory.ruby >= 20000) {
                                    ...
                                    Service.getInstance().sendThongBao(player,
                                            "Bạn không đủ hồng ngọc để mở, còn thiếu "
                                            + Util.numberToMoney((20000 - player.inventory.ruby)) + " hồng ngọc");
                                }
                                break;
                        }
                        ...
                        switch (select) {
                            case 0:
                                if (player.inventory.ruby >= 5000) {
                                    ...
                                    Service.getInstance().sendThongBao(player,
                                            "Bạn không đủ hồng ngọc để mở, còn thiếu "
                                            + Util.numberToMoney((5000 - player.inventory.ruby)) + " hồng ngọc");
                                }
                                break;
                        }
                    ...
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.OPEN_POWER_MYSEFT && player.nPoint.limitPower == 13) {
                        switch (select) {
                            case 0:
                                if (player.inventory.ruby >= 10000 && player.nPoint.power > 599999999999L) {
                                    if (OpenPowerService.gI().openPowerSpeed(player)) {
                                        player.inventory.ruby -= 10000;
                                        Service.getInstance().sendMoney(player);
                                    }
...
//                                            + Util.numberToMoney((10000 - player.inventory.ruby)) + " hồng ngọc");
                                    Service.getInstance().sendThongBao(player,
                                            "Nhà ngươi không đủ điều kiện về mà rèn luyện thêm đi");
                                }
                                break;
                        }
                ...
                if (canOpenNpc(pl)) {
                    switch (select) {
                        case 0:
                            ...
                            break;
                        case 1:
                            if (pl.nPoint.power < 1500000L) {
                                Service.gI().sendThongBaoOK(pl, "Cần 1,5 tr");
                                return;
                            }
                            if (pl.vnd < 20000) {
                                Service.gI().sendThongBaoOK(pl, "Cần nạp ít nhất 20k ");
                                return;
                            }
...
//                                BlackBallWar.gI().reInitNrd();
    ...
    public static Npc npcThienSu64(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (this.mapId == 155) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ta sẽ dẫn cậu tới hành tinh Berrus với điều kiện\n 2. đạt 400 tỷ sức mạnh và Đến nhiệm vụ 24 "
                            + "\n 3. chi phí vào cổng  500 triệu vàng \n 4. mặc đủ 5 món thiên sứ!", "Tới ngay", "Từ chối");
                }
                if (this.mapId == 14) {
                ...
                if (this.mapId == 48) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Đã tìm đủ nguyên liệu cho tôi chưa?\n Tôi sẽ giúp cậu mạnh lên kha khá đấy!\n\b|7| Điều kiện học Tuyệt kỹ\b|5| -Khi chưa học skill cần: x999 Bí kiếp tuyệt kỹ + 2k Hồng ngọc và SM trên 60 Tỷ\n -Mỗi một cấp yêu cầu Thông thạo đạt MAX 100% và cần 2k Hồng ngọc", "Hướng Dẫn",
                            "Đổi SKH VIP", "Học\ntuyệt kĩ", "Đổi SKH Hủy Diệt", "Từ Chối");
                }
            }
...
//            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    ...
                    if (player.iDMark.isBaseMenu() && this.mapId == 155) {
                        if (select == 0) {
                            if (player.setClothes.setDTS == 5) {
                                if (player.getSession().player.nPoint.power >= 400000000000L && player.inventory.gold > COST_HD && TaskService.gI().getIdTask(player) > ConstTask.TASK_24_0) {
                                    player.inventory.gold -= COST_HD;
                                    Service.getInstance().sendMoney(player);
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 146, -1, -1);
                                } else {
                                ...
                                this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Yêu cầu mang đủ 5 món Thiên sứ", "Đóng");
                            }
                        }
                        if (select == 1) {
                        }
                                ...
                                if (player.gender == 0) {
                                    ...
                                    if (curSkill.point == 0) {
                                        ...
                                        if (player.nPoint.power >= 60000000000L) {
                                            ...
                                            } else if (player.inventory.ruby > 2_000 && honLinhThu.quantity >= 999) {
                                                player.inventory.ruby -= 2_000;
                                        ...
                                        if (curSkill.currLevel == 1000 && player.inventory.ruby < 2_000) {
                                            Service.getInstance().sendThongBao(player, "Không đủ Hồng ngọc");
                                        } else if (curSkill.currLevel == 1000 && player.inventory.ruby > 2_000) {
                                            player.inventory.ruby -= 2_000;
                                            Service.getInstance().sendMoney(player);
                                ...
                                case 0:
                                    if (player.playerTask.sideTask.template != null) {
                                        ...
                                        this.createOtherMenu(player, ConstNpc.MENU_OPTION_LEVEL_SIDE_TASK,
                                                ...
                                                + "sức cậu có thể làm được cái nào?\b|5|Phần thưởng:\b|7| Dễ: 1 Thỏi vàng\n Bình thường: 2 Thỏi vàng\n Khó: 3 Thỏi vàng\n Siêu khó: 4 Thỏi vàng\n Địa ngục: 6 Thỏi vàng",
...
//                                            ("Tuổi Thơ\n" + (player.isTitleUse3 == true ? "'ON'" : "'OFF'") + "\n"));
    ...
    public static Npc thanwar(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            "|7| NHẬN ĐỒ VÕ SĨ \n|6|Ta Vừa Bú Được Đống Đồ Võ Sĩ Ngươi Có Muốn Mặc Thử Không ?\b|1|HaHa HaHa?",
                            "Đồng Ý", "Đóng");
                }
            }
...
//                                        int thututop = 1;
//                                        String gitfcodetop = "";
//                                            for (TOP x : Manager.topSM) {
//                                                if (x.getId_player() == player.id) {
//                                                    // Service.getInstance().sendThongBao(player, "bạn nhận được quà top :" + thututop);
//                                                    for(int i=1;i<31;i++){
//                                                        if(thututop==i){
//                                                        gitfcodetop = "top"+i+"sm"+"abc"+i*i+i+i+"check";
//                                                        } 
//                                                    }                                               
//                                                   this.createOtherMenu(player, ConstNpc.BASE_MENU, "bạn nhận được quà top :" + thututop +"\n"+ gitfcodetop ,  "Đóng");
//                                                }else{
//                                                     Service.getInstance().sendThongBao(player, "Rất tiết chúng tôi không có quà cho bạn ");
//                                                }
//                                                thututop++;
//                                            }
                                        //Service.getInstance().sendThongBao(player, "Chưa mở");
                                        ShopServiceNew.gI().opendShop(player, "VO_SI", true);
                                        break;
                                    }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            ...
                            "Top Trung thu", "Nhận quà TOP", "Top Sức mạnh", "Top Nhiệm vụ", "Top Săn BOSS", "Top Nạp", "Đóng");
                }
            }
                            ...
                            switch (player.iDMark.getIndexMenu()) {
                                case ConstNpc.BASE_MENU:
                                    if (select == 0) {
                                        ...
                                        //Service.getInstance().sendThongBao(player, "hiện chưa có top");
                                        break;
                                    }
                                    if (select == 1) {
                                        //Service.gI().showListTop(player, Manager.topHP);                                       
                                        Service.getInstance().sendThongBao(player, "Tính năng đang được cập nhật");
                                        break;
                                    }
                                    if (select == 2) {
                                        Service.gI().showListTop(player, Manager.topSM);
                                        //Service.getInstance().sendThongBao(player, "có xem được đâu mà xem");
                                        break;
                                    }
                                    if (select == 3) {
                    ...
                    try {
                        ...
                        if (biKiep != null) {
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Bạn đang có " + biKiep.quantity + " bí kiếp.\n"
                                    + "Hãy kiếm đủ 1000 bí kiếp và 200 Hồng ngọc tôi sẽ dạy bạn cách dịch chuyển tức thời của người Yardart", "Học dịch\nchuyển", "Đóng");
                        } else {
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    try {
                        Item biKiep = InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 590);
                        if (biKiep != null) {
                            if (biKiep.quantity >= 1000 && InventoryServiceNew.gI().getCountEmptyBag(player) > 0 && player.inventory.ruby > 200) {
                                player.inventory.ruby -= 200;
                                Service.getInstance().sendMoney(player);
                                ...
                                InventoryServiceNew.gI().subQuantityItemsBag(player, biKiep, 1000);
                                InventoryServiceNew.gI().sendItemBags(player);
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.THAN_WAR:
                    return thanwar(mapId, status, cx, cy, tempId, avatar);
//                case ConstNpc.POTAGE:
//                    return Potage(mapId, status, cx, cy, tempId, avatar);    
