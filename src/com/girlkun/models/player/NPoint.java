...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        //set vosi
        if (this.player.setClothes.vosi == 5) {
            this.hpMax += ((double) this.hpMax * 40 / 100);
        }
        //ngọc rồng đen 1 sao
        ...
        if (player.taixiu.chuyensinh > 0) {
            if (player.taixiu.chuyensinh <= 10) {
                hpMax += (220000) * player.taixiu.chuyensinh;
            }
            if (player.taixiu.chuyensinh <= 20 && player.taixiu.chuyensinh > 10) {
                hpMax += (440000) * (player.taixiu.chuyensinh);
            }
            if (player.taixiu.chuyensinh > 20) {
                hpMax += (900000) * (player.taixiu.chuyensinh);
            }
        }
        ...
        // item thiên sứ 
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isTom) {
            this.hpMax += ((double) this.hpMax * 5 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isBanhTet) {
            this.hpMax += ((double) this.hpMax * 20 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isSup) {
            this.hpMax += ((double) this.hpMax * 10 / 100);
        }
...
//        if (!this.player.isPet && this.player.itemTime.isDuoikhi
//                || this.player.isPet && ((Pet) this.player).master.itemTime.isDuoikhi) {
//            this.tiemNang += ((double) this.tiemNang* 10 / 100);
//        }
        if (this.player.isPl()) {
    ...
    private void setMpMax() {
        ...
        if (this.player.setClothes.tabi >= 2) {
         ...
         //set vosi
        if (this.player.setClothes.vosi == 5) {
            this.hpMax += ((double) this.mpMax * 40 / 100);
        }
        //set nhật ấn
        ...
        if (player.taixiu.chuyensinh > 0) {
            if (player.taixiu.chuyensinh <= 10) {
                mpMax += (220000) * player.taixiu.chuyensinh;
            }
            if (player.taixiu.chuyensinh <= 20 && player.taixiu.chuyensinh > 10) {
                mpMax += (440000) * (player.taixiu.chuyensinh);
            }
            if (player.taixiu.chuyensinh > 20) {
                mpMax += (900000) * (player.taixiu.chuyensinh);
            }
        }
        //bổ khí
    ...
    private void setDame() {
        ...
        // item thiên sứ 
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isCua) {
            this.dame += ((double) this.dame * 5 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isBanhChung) {
            this.dame += ((double) this.dame * 20 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isBachTuot) {
            this.dame += ((double) this.dame * 5 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isHamburger) {
            this.dame += ((double) this.dame * 10 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isThuocMo) {
            this.dame += ((double) this.dame * 10 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isThuocMoDB) {
            this.dame += ((double) this.dame * 10 / 100);
        }
        if (this.player.itemTimesieucap != null && this.player.itemTimesieucap.isUseXiMuoi) {
            this.dame += ((double) this.dame * 20 / 100);
        ...
        if (player.taixiu.chuyensinh > 0) {
            ...
            if (player.taixiu.chuyensinh > 20) {
                dame += (50000) * (player.taixiu.chuyensinh);
            }
        }
        //ngọc rồng đen 1 sao
        if (this.player.rewardBlackBall.timeOutOfDateReward[0] > System.currentTimeMillis()) {
        ...
        //set vosi
        if (this.player.setClothes.vosi == 5) {
            this.dame += ((double) this.dame * 24 / 100);
        }
        //set bory
        if (this.player.setClothes.broly == 5) {
            this.dame += ((double) this.dame * 100 / 100);
    ...
    public double calSucManhTiemNang(double tiemNang) {
        if (power < getPowerLimit()) {
            ...
            if (!this.player.isPet && this.player.itemTimesieucap.iscbs
                    || this.player.isPet && ((Pet) this.player).master.itemTimesieucap.iscbs) {
                tiemNang += tn * 3;
            }
    ...
    public double calSubTNSM(double tiemNang) {
        if (power >= 600000000000L) {
            tiemNang /= 25000;
        } else if (power >= 550000000000L) {
            tiemNang /= 17000;
    ...
    public double subDameInjureWithDeff(double dame) {
        ...
        if (this.player.itemTimesieucap.isGato) {
            dame /= 1.1;
        }
        if (dame < 0) {
            dame = 1;
    ...
    public long getPowerLimit() {
        switch (limitPower) {
            ...
            case 12:
                return 550999999999L;
            case 13:
                return 600999999999L;
            case 14:
                return 650999999999L;
            default:
                return 0;
        }
    }
