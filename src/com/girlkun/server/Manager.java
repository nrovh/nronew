...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final String queryTopSM = "SELECT id, (CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(data_point, ',', 2), ',', -1) AS UNSIGNED) + IFNULL(CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(JSON_EXTRACT(pet, '$[1]'), ',', 2), ',', -1) AS UNSIGNED), 0)) as sm FROM player WHERE account_id not in (SELECT id FROM account WHERE is_admin = 1)ORDER BY sm DESC LIMIT 50;";

    public static final String queryTopSMALL = "SELECT id,name,\n"
            + "       CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(data_point, ',', 2), ',', -1) AS UNSIGNED) AS sm,\n"
            + "       Cast(SUBSTRING_INDEX(SUBSTRING_INDEX(pet, ',', 8), ',', -1) AS UNSIGNED) AS smdt\n"
            + "FROM player \n"
            + "WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1)\n"
            + "ORDER BY sm+smdt DESC\n"
            + "LIMIT 50;";
    ...
    public static final String queryTopHP = "SELECT id, \n"
            ...
            + "FROM player WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1)\n"
            + "ORDER BY hp DESC\n"
            + "LIMIT 50;";
    ...
    public static final String queryTopNV = "SELECT id,a.name,nv from player as a INNER join (SELECT name,CAST(SUBSTRING(data_task, 2, 2) AS INTEGER) as nv from player) as b on a.name=b.name WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1) ORDER BY `b`.`nv` DESC LIMIT 50";
    public static final String querytopSB = "SELECT id, CAST( split_str( data_inventory,',',5)  AS UNSIGNED) AS event FROM player WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1) ORDER BY CAST( split_str( data_inventory,',',5)  AS UNSIGNED) DESC LIMIT 20;";
    public static final String querytopSK = "SELECT id, CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(data_inventory, ',', 4), ',', -1) AS UNSIGNED) AS event FROM player WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1) ORDER BY CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(data_inventory, ',', 4), ',', -1) AS UNSIGNED) DESC LIMIT 30;";
    ...
    public static final String queryTopVND = "SELECT id, CAST( vnd AS UNSIGNED) AS vnd FROM player WHERE account_id NOT IN (SELECT id FROM account WHERE is_admin = 1) ORDER BY CAST( vnd AS UNSIGNED) DESC LIMIT 50;";
    ...
    public static final byte[] itemIds_NR_SB = {17, 16, 15};
    ...
    public static final short[] aotd = {0, 138, 139, 230, 231};
    public static final short[] quantd = {6, 142, 143, 242, 243};
    public static final short[] gangtd = {21, 146, 147, 254, 255};
    public static final short[] giaytd = {27, 150, 151, 266, 267};
    public static final short[] aoxd = {2, 170, 171, 238, 239};
    public static final short[] quanxd = {8, 174, 175, 250, 251};
    public static final short[] gangxd = {23, 178, 179, 262, 263};
    public static final short[] giayxd = {29, 182, 183, 274, 275};
    public static final short[] aonm = {1, 154, 155, 234, 235};
    public static final short[] quannm = {7, 158, 159, 246, 247};
    public static final short[] gangnm = {22, 162, 163, 258, 259};
    public static final short[] giaynm = {28, 166, 167, 270, 271};

    public static final short[] aotdv = {232, 233, 555};
    public static final short[] quantdv = {244, 245, 556};
    public static final short[] gangtdv = {256, 257, 562};
    public static final short[] giaytdv = {268, 269, 563};
    public static final short[] aoxdv = {240, 241, 559};
    public static final short[] quanxdv = {252, 253, 560};
    public static final short[] gangxdv = {264, 265, 566};
    public static final short[] giayxdv = {276, 277, 567};
    public static final short[] aonmv = {236, 237, 557};
    public static final short[] quannmv = {248, 249, 558};
    public static final short[] gangnmv = {260, 261, 564};
    public static final short[] giaynmv = {272, 273, 565};
    
    public static final short[] aotdv1 = {555,650};
    public static final short[] quantdv1 = {556,651};
    public static final short[] gangtdv1 = { 562,657};
    public static final short[] giaytdv1 = { 563,658};
    public static final short[] aoxdv1 = {559,654};
    public static final short[] quanxdv1 = { 560,655};
    public static final short[] gangxdv1 = { 566,661};
    public static final short[] giayxdv1 = { 567,662};
    public static final short[] aonmv1 = { 557,652};
    public static final short[] quannmv1 = { 558,653};
    public static final short[] gangnmv1 = {564,659};
    public static final short[] giaynmv1 = { 565,660};
    
    public static final short[] radaSKHHD = { 561, 656};
    public static final short[] radaSKHVip = {280, 281, 561};
    public static final short[] radaSKHThuong = {12, 184, 185, 186, 187};

     public static final short[][][] doSKHHD = {{aotdv1, quantdv1, gangtdv1, giaytdv1}, {aonmv1, quannmv1, gangnmv1, giaynmv1}, {aoxdv1, quanxdv1, gangxdv1, giayxdv1}};
    public static final short[][][] doSKHVip = {{aotdv, quantdv, gangtdv, giaytdv}, {aonmv, quannmv, gangnmv, giaynmv}, {aoxdv, quanxdv, gangxdv, giayxdv}};
    public static final short[][][] doSKHThuong = {{aotd, quantd, gangtd, giaytd}, {aonm, quannm, gangnm, giaynm}, {aoxd, quanxd, gangxd, giayxd}};
