...
//                }else
                ...
                if (rs.getBoolean("ban")) {
                    Service.getInstance().sendThongBaoOK(session, "Tài khoản của bạn đã bị khóa. Lý do : Tại admin nó thích :>> !!!");
...
//                    Service.getInstance().sendThongBaoOK(session, "Tài khoản đang được đăng nhập tại máy chủ khác");
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            if (player.vnd < 100000) {
                                player.name = rs.getString("name");
                            }else if (player.vnd < 500000) {
                                player.name = "[SVIP] "+ rs.getString("name");
                            }else{
                                player.name = "[SSVIP] "+ rs.getString("name");
                            }
